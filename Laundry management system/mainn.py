...
class mainscr:
    ...
    def screen(self):
        self.mainscreen = Tk()
        self.mainscreen.geometry('500x580')
        ...
        self.registerbutton= Button(self.mainscreen, text='REGISTER', font=("gotham", 16, "bold"), width=22,height=2, bd=0,fg='red',bg='black',command=registrationscr)
        self.registerbutton.place(x=120,y=100)

        self.loginbutton= Button(self.mainscreen, text='ORDER', font=("gotham", 16, "bold"), width=22,height=2, bd=0,fg='red',bg='black',command=lgscr)
        self.loginbutton.place(x=120,y=200)

        self.servicepointbutton= Button(self.mainscreen, text='SERVICE POINT STATUS', font=("gotham", 16, "bold"), width=22,height=2, bd=0,fg='red',bg='black',command=allocationscreen)
        self.servicepointbutton.place(x=120,y=300)

        self.reportbutton= Button(self.mainscreen, text='REPORT', font=("gotham", 16, "bold"), width=22,height=2, bd=0,fg='red',bg='black',command=reportscreen)
        self.reportbutton.place(x=120,y=400)
